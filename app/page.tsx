  ...
  const features = [
    {
      ...
      description:
        "Automatically rate leads based on behavior, engagement, and potential to convert.",
      icon: Bot,
    },
    {
      title: "Smart Email Follow-ups",
      description:
        "AI-crafted personalized follow-ups that increase engagement and conversion rates.",
      icon: Mail,
    },
    {
      title: "Predictive Analytics",
      description:
        "Know which leads are most likely to convert with advanced AI prediction models.",
      icon: LineChart,
    },
    {
      title: "Chatbot Integration",
      description:
        "24/7 AI-based lead interaction that captures information and qualifies prospects.",
      icon: MessageSquare,
    },
    {
      title: "Insightful Dashboard",
      description:
        "Visualize lead health, team performance, and conversion metrics in real-time.",
      icon: BarChart3,
    },
    {
      title: "Automated Workflows",
      description:
        "Create custom lead nurturing sequences that run on autopilot.",
      icon: CheckCircle2,
    },
  ];
    ...
    <section className="py-20 bg-gradient-to-b from-transparent to-blue-50 dark:to-blue-900/20">
      <div className="container mx-auto px-4">
        ...
        <p className="text-xl text-center mb-12 max-w-2xl mx-auto text-muted-foreground">
          Everything you need to capture, nurture, and convert more leads with
          less effort
        </p>
  ...
  const steps = [
    {
      title: "Capture Leads",
      description:
        "Collect leads from forms, chatbots, and CRM integrations automatically.",
      icon: CheckCircle2,
    },
    {
      title: "AI Scores & Segments",
      description:
        "Our AI analyzes and scores leads based on behavior and likelihood to convert.",
      icon: Bot,
    },
    {
    ...
    },
    {
      ...
      description:
        "Monitor performance and optimize your sales funnel with real-time analytics.",
      icon: LineChart,
    },
  ];
          ...
          <div className="space-y-12 relative z-10">
            {steps.map((step, index) => (
              ...
              >
                <div
                  className={`flex-1 ${
                    index % 2 === 0 ? "md:text-right md:order-1" : "md:order-3"
                  }`}
                >
  ...
  const testimonials = [
    {
      ...
      content:
        "Using LeadFlow AI helped us increase our lead conversion by 38% in just 2 months!",
    ...
    },
    {
      ...
      content:
        "The AI-powered lead scoring has completely transformed how we prioritize our sales efforts.",
      avatar: "/placeholder.svg?height=40&width=40",
    },
    {
      name: "Sarah Williams",
      ...
      content:
        "The automated follow-ups feel so personal that our customers think they're talking to a real person.",
      avatar: "/placeholder.svg?height=40&width=40",
    },
  ];
  ...
  return (
    <section className="py-20">
      <div className="container mx-auto px-4">
        ...
        <p className="text-xl text-center mb-12 max-w-2xl mx-auto text-muted-foreground">
          Join hundreds of businesses already growing with our AI-powered
          solution
        </p>
      ...
      <div className="container mx-auto px-4 text-center">
        ...
        >
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Join hundreds of businesses already growing with our AI-powered lead
            management system.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              AI-powered lead management system that helps businesses convert
